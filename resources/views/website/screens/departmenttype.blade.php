...
<html lang="en">
   ...
   <head>
	 ...
	 <title>Farhat Hospital|departmets|type</title>
				 	...
				 	<div class="row">
				 		...
				 		<div class="col-lg-8">
				 			<div class="txt-block pr-30">
				 				...
				 				<div class="content-block mb-40">
									...
									<!-- Small Title -->
									<h5 class="h5-md steelblue-color">Feugiat primis ultrice</h5>
									...
									<div class="content-block-img">
										<img class="img-fluid" src="{{url('website/images/cardiology_1000x500.jpg')}}" alt="content-image">
									</div>
						...
						<aside id="sidebar" class="col-lg-4">
							...
							<div id="txt-widget" class="sidebar-div mb-50">
								...
								<div class="txt-widget-unit mb-15 clearfix d-flex align-items-center">
									...
									<div class="txt-widget-avatar">
										<img src="{{url('website/images/head-of-clinic.jpg')}}" alt="testimonial-avatar">
									</div>
							...
							<div id="image-widget" class="sidebar-div">
								<a href="#">
									<img class="img-fluid" src="{{url('website/images/blog/image-widget.jpg')}}" alt="image-widget" />
								</a>																		
							</div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="about-img text-center wow fadeInUp" data-wow-delay="0.6s">
								<img class="img-fluid" src="{{url('website/images/image-03.png')}}" alt="about-image">
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Text -->
								<p>Farhat Hospital Sahiwal stands as a beacon of comprehensive healthcare, offering a full spectrum of medical solutions under one roof. In an era where navigating multiple healthcare providers can be daunting, Farhat Hospital simplifies the process by integrating all essential services into one accessible location.
								</p>
