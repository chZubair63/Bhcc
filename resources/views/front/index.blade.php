...
<body>
  ...
  <!-- Core Functions -->
  <section class="core-functions text-center py-5">
    <div class="container">
  ...
  <!-- Clinical Governance -->
  <section class="cgds-section py-5">
    <div class="container">
      <h2 class="text-danger text-center mb-4">CLINICAL GOVERNANCE & DELIVERY STANDARDS</h2>
      <div class="row align-items-center">
        <div class="col-md-6"><img src="images/Rectangle 195.jpg" class="img-fluid rounded"></div>
        <div class="col-md-6">
          <p> Ensuring Excellence in Patient Care Upholding Safety, Accountability, and Continuous Quality Improvement Across Balochistan.</p>
          <ul>
            <li>Guaranteeing Safe, Patient-Centered Care Aligned with National Standards.</li>
            <li>Continuous Monitoring and Improvement of Clinical Practices.</li>
            <li>Structured Accountability Through Defined Roles and Transparent Reporting.</li>
      ...
      <div class="row g-4">
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              <h5>Online Survey</h5>
              <p>Some quick description text.</p>
